# Combinatorics
There are a lot of computational math problems that needs knowledge of combinatorics to solve. And it is often hard to interpret com
...
Now we will need the value of `(n^-1)!%P` to count inverse factorials. The only way I know is using Big Mod theory.<br />
